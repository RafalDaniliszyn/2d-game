...
public class MapaKafelkowKanwa {
    int wielkoscKafelka = 60;
    int x = 0;
    int y = 0;
    int liczbaKafelkow = 10;
    ...
    MapaKafelkowKanwa(){
        try {
            scannerPoziom0 = new Scanner(new File("C:\\Users\\Rafal\\Gra\\src\\pl\\rafal\\tabliceMap\\tablicaMapyKanwa.txt"));
            scannerPoziom1 = new Scanner(new File("C:\\Users\\Rafal\\Gra\\src\\pl\\rafal\\tabliceMap\\tablicaMapyKanwaPoziom1.txt"));
    ...
    void wczytajKafelki(){
        for (int i = 0; i < kafelkiImage.length; i++) {
            try {
                this.kafelkiImage[i] = ImageIO.read(new File("C:\\Users\\Rafal\\Gra\\src\\pl\\rafal\\obrazki\\" + String.valueOf(i) + "kanwa.png"));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
